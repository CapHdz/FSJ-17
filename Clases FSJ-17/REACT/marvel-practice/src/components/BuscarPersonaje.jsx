...
export default function BuscarPersonaje() {
    ...
    const obtenerPersonajeByNombre = () => {
        axios.get(`https://gateway.marvel.com/v1/public/characters?name=${name}&ts=1&apikey=8be4a40aa5e3e301ec0f2a74266c4391&hash=23b90b396d7a2c629daf3656bf64aef4`).then((response) => {
