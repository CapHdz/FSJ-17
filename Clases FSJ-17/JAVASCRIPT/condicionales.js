...
let edad = prompt("Ingrese su edad"); // con prompt solicitamos datos desde el navegador
if (edad >= 18) {
...
// operador ternario => manera mas optimizada para utilizar el if else

//verificar si el numero esta en el rango entre 50 y 150
let numero = prompt("Ingrese un numero");
// if = ? si la condicion cumple mandamos un cierto codigo
